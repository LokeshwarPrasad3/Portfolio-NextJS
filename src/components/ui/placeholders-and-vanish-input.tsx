  ...
  return (
    ...
    >
      ...
      <input
        ...
        type="text"
        className={cn(
          "relative z-50 h-full w-full rounded-full border-none bg-transparent pr-14 pl-4 text-sm text-black focus:ring-0 focus:outline-none sm:pl-7 sm:text-base dark:text-white",
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className="w-[calc(100%-2rem)] truncate pl-4 text-left text-sm font-normal text-neutral-500 sm:pl-9 sm:text-base dark:text-zinc-400"
            >
